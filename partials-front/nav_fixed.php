<nav id="navbar" class="bg-gray-500 h-auto z-10">
    ...
    <!-- Mobile menu -->
    <div id="mobile-menu" class="hidden md:hidden shadow-md text-center border-t px-3 py-5 bg-gray-100">
...
<!-- Bottom nav -->
<div class="fixed flex bottom-0 inset-x-0 bg-gray-100 justify-between text-sm md:hidden uppercase rounded-t-lg font-mono border-t z-10">
    <a href="<?= SITEURL; ?>" class="block text-center p-2 w-full hover:bg-gray-200 hover:text-gray-900">
        <i class="bx bx-home text-xl"></i> <br>Home
    </a>
    <a href="<?= SITEURL; ?>categories.php" class="block text-center p-2 w-full hover:bg-gray-200 hover:text-gray-900">
        <i class="bx bx-search text-xl"></i> <br>Discover
    </a>
    <a href="<?= SITEURL; ?>portfolios.php" class="block text-center p-2 w-full hover:bg-gray-200 hover:text-gray-900">
        <i class="bx bx-movie text-xl"></i> <br>Spoils
    </a>
    <a href="<?= SITEURL; ?>admin/" class="block text-center p-2 w-full hover:bg-gray-200 hover:text-gray-900">
